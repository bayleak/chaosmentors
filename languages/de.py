...
'Chaosmentors-Welcome-Title': 'Willkommen bei den Chaospatinnen',
...
'Profile': 'Profil',
'Project Introduction': 'Das Chaospatinnen Projekt ist für Menschen gedacht, die zum ersten mal einen Chaos Event des **CCC** (Chaos Computer Club) besuchen wollen.  \r\n\r\nDie Erfahrung hat gezeigt, dass viele Menschen bei ihrem ersten Besuch zunächst unsicher sind, wie man sich auf einem Hacker-Event verhält, was man dort machen kann und wie das alles abläuft.  \r\nGenau dafür ist dieses Projekt da. Wir wollen Neulingen die Scheu nehmen und ihnen den Einstieg in diese Community erleichtern.  \r\n\r\nWir führen euch herum, zeigen euch alles und versuchen euch, basierend auf euren Interessen, mit den passenden Gruppen/Projekten in Kontakt zu bringen.',
...
'The Views': 'Die Views',
'This App': 'Diese App',
'This email already has an account': 'Diese E-Mail ist bereits vergeben',
...
'View': 'Ansicht',
'Welcome': 'Willkommen',
'Welcome to the Chaosmentors': 'Willkommen bei den Chaospatinnen',
